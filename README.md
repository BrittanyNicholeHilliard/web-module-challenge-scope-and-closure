...
x Fork the repo
x. Clone your forked version of the repo
x. cd into your repo and create a branch with your first and last name
x. open the terminal in your vs code and type `npm install`
x. next type `npm run test:watch` in your terminal
